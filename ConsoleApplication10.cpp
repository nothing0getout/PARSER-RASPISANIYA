...
private:
    ...
    /**
        @brief Парсит строчку с экранными символами
        @return Нормальная строка для дальнейшей обработки
    */
    string parseString() {
        if (json[pos] != '"') return "";
...
public:
    ...
    */
    ...
    /**
        ...
        @return json код ответат сервера, без спец символов
    */
    string getRawJson() {
        return json;
    }
...
int main() {
    ...
    string url = "https://msapi.top-academy.ru/api/v2/schedule/operations/get-month?date_filter=2026-02-16"; //api ссылка
    vector<string> headers
    { "referer: https://journal.top-academy.ru/" };
    cout << "PLS give me Bearer: " << endl;
    string Bearer;
    cin >> Bearer;
    ...
    map<string, int> themes = parser.countSubjects();
